!(function (t, e) {
    ...
    var s,
        ...
        ur =
            ...
            (D = ".active"),
            (N = ".btn"),
            (O = { CLICK_DATA_API: "click" + y + E, FOCUS_BLUR_DATA_API: "focus" + y + E + " blur" + y + E }),
            (k = (function () {
                function t(t) {
                    this._element = t;
                }
            ...
            (U = "left"),
            (G = "right"),
            (W = { SLIDE: "slide" + L, SLID: "slid" + L, KEYDOWN: "keydown" + L, MOUSEENTER: "mouseenter" + L, MOUSELEAVE: "mouseleave" + L, TOUCHEND: "touchend" + L, LOAD_DATA_API: "load" + L + P, CLICK_DATA_API: "click" + L + P }),
            (B = "carousel"),
            (K = "active"),
            (V = "slide"),
                    ...
                    (e._slide = function (t, e) {
                        ...
                        if ((t === Q ? ((n = q), (i = z), (r = U)) : ((n = Y), (i = X), (r = G)), l && $(l).hasClass(K))) this._isSliding = !1;
                            ...
                            hr.supportsTransitionEnd() && $(this._element).hasClass(V)
                                ...
                                : ($(s).removeClass(K), $(l).addClass(K), (this._isSliding = !1), $(this._element).trigger(u)),
                                h && this.cycle();
                        }
                    }),
                    (t._jQueryInterface = function (e) {
            ...
            (dt = "width"),
            (ft = "height"),
            (pt = { ACTIVES: ".show, .collapsing", DATA_TOGGLE: '[data-toggle="collapse"]' }),
            (mt = (function () {
                function t(t, e) {
            ...
            (Zt = (function () {
                ...
                return (
                    ...
                    (n.toggle = function (t) {
                        if (this._isEnabled)
                            if (t) {
                                ...
                                n || ((n = new this.constructor(t.currentTarget, this._getDelegateConfig())), kt(t.currentTarget).data(e, n)),
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            kt(o).data(this.constructor.DATA_KEY, this),
                                ...
                                (this._popper = new e(this.element, o, {
                                    placement: l,
                                    modifiers: { offset: { offset: this.config.offset }, flip: { behavior: this.config.fallbackPlacement }, arrow: { element: Vt }, preventOverflow: { boundariesElement: this.config.boundary } },
                                    onCreate: function (t) {
                    ...
                    (n._enter = function (t, e) {
                        ...
                        (e = e || kt(t.currentTarget).data(n)) || ((e = new this.constructor(t.currentTarget, this._getDelegateConfig())), kt(t.currentTarget).data(n, e)),
                    ...
                    (n._getConfig = function (t) {
                        return (
                            "number" == typeof (t = r({}, this.constructor.Default, kt(this.element).data(), t)).delay && (t.delay = { show: t.delay, hide: t.delay }),
        ...
        dr =
            ...
            (se = r({}, ur.Default, { placement: "right", trigger: "click", content: "", template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>' })),
            ...
            (be = { ACTIVATE: "activate" + _e, SCROLL: "scroll" + _e, LOAD_DATA_API: "load" + _e + ".data-api" }),
            (Ce = "dropdown-item"),
            (Ie = "active"),
            (Te = {
            ...
            (we = (function () {
                ...
                return (
                    ...
                    (e._activate = function (t) {
                        ...
                        var n = pe(e.join(","));
                        n.hasClass(Ce)
                            ? (n.closest(Te.DROPDOWN).find(Te.DROPDOWN_TOGGLE).addClass(Ie), n.addClass(Ie))
                            : (n.addClass(Ie),
                              n
                            ...
                            pe(this._scrollElement).trigger(be.ACTIVATE, { relatedTarget: t });
                    }),
                    (e._clear = function () {
            ...
            (Oe = "." + (Ne = "bs.tab")),
            (ke = (De = t).fn.tab),
            ($e = { HIDE: "hide" + Oe, HIDDEN: "hidden" + Oe, SHOW: "show" + Oe, SHOWN: "shown" + Oe, CLICK_DATA_API: "click" + Oe + ".data-api" }),
            (je = "dropdown-menu"),
            (Re = "active"),
            (Le = "disabled"),
            (Pe = "fade"),
            ...
            (function () {
                ...
                var i = {
                    ...
                    isChar: function (t) {
                        return (
                            void 0 === t.which ||
                            ("number" == typeof t.which && t.which > 0 && !t.ctrlKey && !t.metaKey && !t.altKey && 8 !== t.which && 9 !== t.which && 13 !== t.which && 16 !== t.which && 17 !== t.which && 20 !== t.which && 27 !== t.which)
                        );
                    },
        ...
        pr =
            ...
            (tn = "has-danger"),
            (en = "input-group"),
            (nn = { FORM_GROUP: "." + "form-group", BMD_FORM_GROUP: "." + (Ze = "bmd-form-group"), BMD_LABEL_WILDCARD: "label[class^='" + (Je = "bmd-label") + "'], label[class*=' " + Je + "']" }),
            (rn = {
                validate: !1,
            ...
            (on = { "form-control-lg": "bmd-form-group-lg", "form-control-sm": "bmd-form-group-sm" }),
            (function (t) {
                function e(e, n, i) {
                    var r;
                    return (
                ...
                return (
                    ...
                    (n.resolveMdbFormGroup = function () {
                        ...
                        return (
                            (void 0 !== t && 0 !== t.length) ||
                                (!this.config.bmdFormGroup.create || (void 0 !== this.$formGroup && 0 !== this.$formGroup.length)
        ...
        gr =
            ...
            (fn = cn.fn[dn]),
            (pn = { template: "<span class='checkbox-decorator'><span class='check'></span></span>" }),
            (mn = (function (t) {
                function e(e, n, i) {
        ...
        _r =
            ...
            (Nn = { IN: "in", COLLAPSE: "collapse", COLLAPSING: "collapsing", COLLAPSED: "collapsed", WIDTH: "width" }),
            (On = {}),
            (kn = (function (t) {
                function e(e, n) {
                    var i;
                    ...
                    (n.rejectWithoutRequiredStructure = function () {
                        dr.assert(this.$element, "label" === !this.outerElement().prop("tagName"), this.constructor.name + "'s " + dr.describe(this.$element) + " parent element " + dr.describe(this.outerElement()) + " should be <label>."),
                            dr.assert(
                                ...
                                this.constructor.name + "'s " + dr.describe(this.$element) + " parent element " + dr.describe(this.outerElement()) + " should have class ." + Fn.FILE + "."
                            );
                    }),
                    (n.addFocusListener = function () {
                        var t = this;
        ...
        yr =
                    ...
                    T = (function () {
                        ...
                        return (
                            ...
                            (s._getConfig = function (n) {
                                ...
                                return (
                                    void 0 !== i.placement && (i.placement = b[i.placement.toUpperCase()]), (n = t.extend({}, this.constructor.Default, t(this._element).data(), n)), hr.typeCheckConfig(e, n, this.constructor.DefaultType), n
                                );
                            }),
                            ...
                            (o._dataApiKeydownHandler = function (e) {
                                if (
                                    !(!a.test(e.which) || (/button/i.test(e.target.tagName) && 32 === e.which) || /input|textarea/i.test(e.target.tagName) || (e.preventDefault(), e.stopPropagation(), this.disabled || t(this).hasClass(c)))
                                ) {
            ...
            (ki = jQuery),
            (Ri = { CANVAS: "." + ($i = "bmd-layout-canvas"), CONTAINER: "." + "bmd-layout-container", BACKDROP: "." + (ji = "bmd-layout-backdrop") }),
            (Li = { canvas: { create: !0, required: !0, template: '<div class="' + $i + '"></div>' }, backdrop: { create: !0, required: !0, template: '<div class="' + ji + '"></div>' } }),
            (function (t) {
                function e(e, n, i) {
                    var r;
    ...
    (Pi = jQuery),
        ...
        (Ki = (function (t) {
            function e(e, n) {
                var i;
                return (
                    ((i = t.call(this, e, Pi.extend(!0, {}, Bi, n)) || this).$toggles = Pi('[data-toggle="drawer"][href="#' + i.$element[0].id + '"], [data-toggle="drawer"][data-target="#' + i.$element[0].id + '"]')),
                    i._addAria(),
                    i.$backdrop
                        .keydown(function (t) {
        ...
        (Xi = Vi.fn[zi]),
        (tr = { CONTAINER: "." + (Zi = "ripple-container"), DECORATOR: "." + (Ji = "ripple-decorator") }),
        (er = {
        ...
        (nr = (function () {
            ...
            return (
                ...
                (e._onStartRipple = function (t) {
                    ...
                    if (!this._isTouch() || "mousedown" !== t.type) {
                        ...
                        var n = this._getRelY(t),
                            i = this._getRelX(t);
                        (n || i) &&
                            (this.$decorator.css({ left: i, top: n, "background-color": this._getRipplesColor() }),
                ...
                (e._findOrCreateContainer = function () {
                    (!this.$container || !this.$container.length > 0) && (this.$element.append(this.config.container.template), (this.$container = this.$element.find(tr.CONTAINER))),
                ...
                (e.rippleOn = function () {
                    ...
                    dr.transitionEndSupported()
                        ? this.$decorator
                              .css({ "-ms-transform": "scale(" + e + ")", "-moz-transform": "scale(" + e + ")", "-webkit-transform": "scale(" + e + ")", transform: "scale(" + e + ")" })
                              .addClass("ripple-on")
                              .data("animating", "on")
                              .data("mousedown", "on")
