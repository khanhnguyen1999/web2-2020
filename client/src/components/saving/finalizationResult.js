                ...
                <div className="modal-dialog modal-notify modal-success" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-header">
                            <p className="heading lead">Tất toán thành công</p>
                        </div>
                        ...
                        <div className="modal-footer justify-content-center">
                            <a type="button" onClick={onClickNext} className="btn btn-success">Quay về TKTK<i className="far fa-gem ml-1 white-text" /></a>
