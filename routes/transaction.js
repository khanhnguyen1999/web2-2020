...
router.post('/', [
    ...
    body('STKHuongThu')
        .custom(async function (STKHuongThu) {
            ...
            if (!STKHuongThu) {
                ...
                const account = await Account.findByAccountNumber(STKHuongThu)
                const beneficiatAccount = await BeneficiatyAccount.findByAccountNumber(STKHuongThu)
    ...
    if (!req.body.STKHuongThu) {
        ...
        {
            const BeneficiaryAccountFalse = await BeneficiatyAccount.findByAccountNumber(req.body.STKHuongThu);
        ...
        {
            fee = 5000;
            const BeneficiaryAccountTrue = await Account.findByAccountNumber(req.body.STKHuongThu);
